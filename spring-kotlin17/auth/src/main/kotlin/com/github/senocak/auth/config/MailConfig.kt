...
class MailConfig(
    ...
    @Value("\${app.mail.smtp.socketFactory.port}")
    ...
    @Value("\${app.mail.smtp.starttls.required}")
    private val startllsRequired = false

    @Value("\${app.mail.smtp.socketFactory.fallback}")
